...
jQuery.fn.extend({
    cropzee: function (options = {
        ...
        window.cropzeeCreateImage = async function (id) {
            ...
            let render_output = {};
            render_output['image'] = img.src;
            let file = getImageFromBase64(render_output)
           ...
           // imgObj.src = URL.createObjectURL(file);
            ...
            if (options.returnImageMode == 'blob') {
                ...
                $("#pollset_image_binary").val(dataURL)
            }
        ...
        function getImageFromBase64(event) {
            ...
            const imageBlob = dataURItoBlob(event.image);
        ...
        $(this).click(function () {
            ...
            $(this).one("change", function () {
                ...
                if ($.inArray(ext, options.allowedInputs) == -1) {
                    // $("#image_error").html('Invalid extension! Please check your input file and try again.');
                    // $('#image').val('');
                    // alert('invalid extension! Please check your input file and try again.');
                    // resetFileInput(cropzeeInputId);
                } else {
                    $("#image_temp_error").html('');
                    $("#image_error").html('');
